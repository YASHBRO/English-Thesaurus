...
In this project, we used WEB SCRAPER to make a DICTIONARY.
Here we worked with PYTHON to scrape data from a site "https://www.vocabulary.com/dictionary/". We worked with a library of python called BEAUTIFUL SOUP to extract data. 
